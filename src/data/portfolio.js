...
export const portfolioData = [
  // Projects
  {
    ...
    description:
      "Inventory management system built with Python (Django) & SQLite. Features authentication, password recovery, and admin panel.",
  ...
  },
  {
    ...
    description:
      "Notification service built with Node.js & PostgreSQL. Features bulk email delivery, analytics, and multi-channel support.",
    shortDescription: "Notification service built with Node.js & PostgreSQL",
  ...
  },
  {
    ...
    description:
      "Bookmark website to keep track of your favorite websites. Created using HTML/CSS/JS.",
  ...
  },
  {
    ...
    description:
      "Calculator web application with functionality to perform basic operations of addition, subtraction, multiplication and division.",
  ...
  },
  {
    ...
    description:
      "Personal portfolio website built with React & Tailwind CSS. Features responsive design, modular components, and SEO optimization.",
  ...
  // Articles
  {
    ...
    description:
      "Article about PHP language and its importance for web developers.",
  ...
  },
  {
    ...
    description:
      "Article about what is the PHP language and why you should learn it.",
  ...
  // About Me / Personal Links
  {
    ...
    description:
      "My GitHub profile showcasing all my projects and contributions.",
